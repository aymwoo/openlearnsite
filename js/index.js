var tip=document.getElementById("move");
		...
		var begin=false;
        var levelsave = window.__indexConfig.gsave;
        var movenote = window.__indexConfig.gnote;
        var gamestart= window.__indexConfig.gstart;
        var timepass= window.__indexConfig.gpass;
        var grank= window.__indexConfig.grank;
		var maparray=[];
		var movearray=[];
		...
		//初始化游戏等级
        //        var levelsave = window.__indexConfig.gsave;        var movenote = window.__indexConfig.gnote;
