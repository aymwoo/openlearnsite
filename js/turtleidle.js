var snum = window.__turtleidleConfig.snum;
	var id = window.__turtleidleConfig.id;
	var tout="";
	var cf = window.__turtleidleConfig.codefile;
		
    var argimg = window.__turtleidleConfig.argimg;
    var fpage = window.__turtleidleConfig.fpage;
    var mhelp = window.__turtleidleConfig.mhelp;
