...
var id = window.__judgeeditConfig.id;
    var cid=window.__judgeeditConfig.cid;
    var mid=window.__judgeeditConfig.mid;
    var num = 1;
    var key = "ls2022"+ id;    
...
function saveshow(){
    var scode=window.__judgeeditConfig.code;
    var sarg1=window.__judgeeditConfig.arg1;
    var sarg2=window.__judgeeditConfig.arg2;
    var sarg3=window.__judgeeditConfig.arg3;
    if(scode!=""){
...
function back(){
    window.location.href=window.__judgeeditConfig.fpage;
}
