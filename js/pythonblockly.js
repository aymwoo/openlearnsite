var snum = window.__pythonblocklyConfig.snum;
    var cvbg = window.__pythonblocklyConfig.mback;
    var cf = window.__pythonblocklyConfig.codefile;
    var id = window.__pythonblocklyConfig.id;
    var fpage = window.__pythonblocklyConfig.fpage;
    var pass = 0;
    ...
    var testg = 0;
    var argck = [0, 0, 0];
    var argcodestr = window.__pythonblocklyConfig.argcode;

    var arginstr = window.__pythonblocklyConfig.argin;
    var argin = arginstr.split("#");

    var argout0 = window.__pythonblocklyConfig.argout0;
    var argout1 = window.__pythonblocklyConfig.argout1;
    var argout2 = window.__pythonblocklyConfig.argout2;
    ...
    var argimg = window.__pythonblocklyConfig.argimg;
    var mhelp = window.__pythonblocklyConfig.mhelp;
