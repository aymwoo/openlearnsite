var fontsize=25;
	    ...
	    var snum = window.__pythonblockConfig.snum;
	    var id = window.__pythonblockConfig.id;
	    var fpage = window.__pythonblockConfig.fpage;
        var argcodestr = window.__pythonblockConfig.argcode;
        var arginstr = window.__pythonblockConfig.argin;
        var argin = arginstr.split("#");

        var argout0 = window.__pythonblockConfig.argout0;
        var argout1 = window.__pythonblockConfig.argout1;
        var argout2 = window.__pythonblockConfig.argout2;
        
        var mpass = window.__pythonblockConfig.mpass;
