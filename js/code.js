var snum = window.__codeConfig.snum;
	var mid = window.__codeConfig.mid;
	var qid = window.__codeConfig.qid;
	var id = window.__codeConfig.id;
	var tout=window.__codeConfig.argout;
	var cf = window.__codeConfig.codefile;
	var title=window.__codeConfig.title;
		
    var argimg = window.__codeConfig.argimg;
    var fpage = window.__codeConfig.fpage;
