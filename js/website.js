// 全局变量
        ...
        var user=window.__websiteConfig.mysnum;
        var id = window.__websiteConfig.id;
        var lid = window.__websiteConfig.lid;
    ...
    if (e.key === 'Escape') {
        ...
        function returnurl() {
            if (confirm('是否离开当前活动页面？请先保存作品。') == true) {
                window.location.href = window.__websiteConfig.fpage
            }
        }
        // 页面加载完成后初始化
