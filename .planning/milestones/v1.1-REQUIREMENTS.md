# Requirements Archive: v1.1 教学环节生成与课堂活动投放
...
- [x] **SCT-01**: Student can submit a result for a published AI-generated
  activity through the activity page.
- [x] **SCT-02**: Student can have completion status recorded after a successful
  activity submission.
...
- Validated: `TAP-01`, `TAP-02`, `TAP-03`, `SAE-01`, `SAE-02`, `SAE-03`,
  `SCT-01`, `SCT-02`
- Adjusted: None
- Dropped: None
