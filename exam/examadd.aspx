<%@ Page Language="C#" AutoEventWireup="true" CodeFile="examadd.aspx.cs" Inherits="exam_examadd" MasterPageFile="~/teacher/Teach.master" %><asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <style>
        ...
        .exam-form-hero, .exam-form-card { border: 1px solid rgba(148, 163, 184, 0.18); border-radius: 1.25rem; background: #ffffff; box-shadow: 0 12px 32px -28px rgba(15, 23, 42, 0.28); }
    ...
    <div class="exam-form-page">
        <div class="exam-form-shell">
            <section class="exam-form-hero">
                <div>
                    <h2 class="exam-form-title">创建考试</h2>
                    <p class="exam-form-subtitle">配置考试名称、试卷、时间窗口和参与对象。整体风格与教师端其他管理页保持一致，减少旧式表单的割裂感。</p>
                </div>
            ...
            <section class="exam-form-card">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <p class="help-text">如无可选试卷，请先<a href="paper/paperadd.aspx">创建试卷</a></p>
                    </div>
                    <div class="form-group">
                        <label>考试类型</label>
